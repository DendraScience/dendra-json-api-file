...
exports.before = {
  // all: [],
  find: [// NOTE: Normally included here, but we don't want to coerce _id and parent_category_id
  ...
  context => {
    ...
    const parentCategoryId = getByDot(context, 'params.query.parent_category_id');
